...
class PolypPVT(nn.Module):
    def __init__(self, channel=32):
        ...
        path = '/mnt/DATA-1/DATA-2/Feilong/scformer/train_polyp/test/Polyp-PVT/pretrained_pth/pvt_v2_b2.pth'
...
#        print('cfm_feature: ',cfm_feature.shape) # 
        ...
        # SAM 
#        print('cim_feature: ',cim_feature.shape) # torch.Size([1, 32, 88, 88])
        T2 = self.Translayer2_0(cim_feature)
#        print('T2: ',T2.shape) # torch.Size([1, 32, 88, 88])
        T2 = self.down05(T2)
#        print('T2:  ',T2.shape) # torch.Size([1, 32, 44, 44])
#        print('cfm_feature:  ',cfm_feature.shape) # [1, 32, 44, 44]
...
#    print(prediction1.size(), prediction2.size())
    ...
    MitEncoder = PolypPVT().to('cuda')
    from torchinfo import summary
#    summary(MitEncoder, (1, 3, 352, 352))
